...
<head>
  ...
  <title>شدات ببجي مجانية - PUBG UC Generator</title>
  ...
  <style>
    ...
    * {
    ...
    body {
      ...
      background: linear-gradient(135deg, var(--pubg-dark) 0%, var(--pubg-blue) 100%);
      color: white;
      line-height: 1.6;
      min-height: 100vh;
      padding: 0;
    ...
    .hero {
      padding: 60px 0;
      text-align: center;
      background: url('https://i.ibb.co/b5Xy17qW/1000056085.jpg') no-repeat center center/cover;
      position: relative;
    }
    ...
    .feature-card {
      ...
      padding: 25px;
      text-align: center;
      border: 1px solid var(--pubg-light);
    ...
    .screenshot-card {
      ...
      position: relative;
      border: 2px solid var(--pubg-dark-gold);
    ...
    .download-btn {
      ...
      align-items: center;
      gap: 10px;
      background: linear-gradient(145deg, var(--pubg-gold), var(--pubg-dark-gold));
      color: #000;
      font-weight: 800;
      font-size: 20px;
      padding: 16px 40px;
    ...
    .dialog-content {
      background: linear-gradient(to bottom, var(--pubg-blue), var(--pubg-dark));
      color: white;
      padding: 30px;
      border-radius: 15px;
      text-align: center;
...
<body>
  ...
  <header class="header">
    <div class="container">
      <div class="header-content">
        <div class="logo">
          <img src="https://i.ibb.co/b5Xy17qW/1000056085.jpg" alt="PUBG Logo">
          <div class="logo-text">شدات ببجي</div>
        </div>
        <nav class="nav-links">
          <a href="#">الرئيسية</a>
          <a href="#">المميزات</a>
  ...
  <section class="hero">
    <div class="container">
      <div class="hero-content">
        <h1 class="hero-title">احصل على شدات ببجي مجانية الآن</h1>
        <p class="hero-subtitle">طور أداءك في اللعبة مع تطبيق شدات ببجي الحصري الذي يوفر لك شدات مجانية بشكل يومي</p>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="features">
        <div class="feature-card">
          ...
          <h3 class="feature-title">شحن فوري</h3>
          <p>احصل على شداتك بشكل فوري بعد التفعيل دون انتظار</p>
        </div>
        <div class="feature-card">
          <div class="feature-icon">
          ...
          <p>تطبيق آمن وموثوق لا يؤثر على حسابك في اللعبة</p>
        </div>
        <div class="feature-card">
          <div class="feature-icon">
          ...
          <p>احصل على شدات مجانية بشكل يومي دون أي تكلفة</p>
        </div>
      </div>

      <!-- Screenshots Section -->
      <h2 class="section-title">معرض الشدات</h2>
      <div class="screenshots">
        <div class="screenshot-card">
          <img src="https://i.ibb.co/7dcYXy16/1000056087.png" alt="PUBG UC Screenshot">
        </div>
        <div class="screenshot-card">
          <img src="https://i.ibb.co/1JhmckMJ/1000056089.png" alt="PUBG UC Screenshot">
        </div>
        <div class="screenshot-card">
          <img src="https://i.ibb.co/MDfymw1T/1000056091.png" alt="PUBG UC Screenshot">
        </div>
      </div>

      <!-- Download Section -->
      <div class="download-section">
        <h2 class="download-title">نزل التطبيق الآن</h2>
        <p class="download-text">اضغط على زر التحميل لتحصل على تطبيق شدات ببجي المجاني واحصل على شداتك الآن</p>
  ...
  <footer class="footer">
    <div class="container">
      <p class="footer-text">© 2023 تطبيق شدات ببجي. جميع الحقوق محفوظة</p>
    </div>
  </footer>
  ...
  <div id="dialog" class="dialog">
    <div class="dialog-content">
      <h3 class="dialog-title">جاري التحميل...</h3>
      <p class="dialog-text">
        بعد انتهاء التحميل:<br>
        1️⃣ اضغط فتح الملف<br>
        2️⃣ أو ادخل على التنزيلات<br>
        3️⃣ ثم اضغط تثبيت ✅
      </p>
      <button class="dialog-btn" onclick="closeDialog()">تم</button>
    </div>
  </div>
  ...
  <script>
    function downloadApp() {
      ...
      setTimeout(function() {
        window.location.href = "هتحط رابط التنزيل هنا اين كان الرابط ممكن ترفعه على جتهب او مديا فير او اي حاجه";
      }, 2000);
    }
